...
#ifndef HW_SIEGE_16S_CORE_H_
#define HW_SIEGE_16S_CORE_H_

#ifdef SIEGE_16S
  #define HW_NAME			"SIEGE_16S"  
#else
...
#define CURRENT_SHUNT_RES		0.00015
#endif
...
#define MCCONF_L_MIN_VOLTAGE			12.0		// Minimum voltage input
#endif
